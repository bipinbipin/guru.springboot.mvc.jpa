...
import guru.springboot.controllers.ProductController;
...
public class ProductControllerTest {
    ...
    @InjectMocks  //sets up controller, and inject mock object into it.
    ...
    public void testList() throws Exception {
        ...
        when(productService.listAllProducts()).thenReturn((List) products); //need to strip generics to ...
    ...
    public void testSaveOrUpdate() throws Exception {
        ...
        when(productService.saveProduct(Matchers.<Product>any())).thenReturn(returnProduct);
        ...
        verify(productService).saveProduct(boundProduct.capture());
